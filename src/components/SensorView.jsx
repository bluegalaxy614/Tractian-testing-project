...
const SensorView = ({ selectedSensor }) => {
    ...
    selectedSensor && (
      <div>
        <div className="flex items-center w-full h-[56px] border-b border-gray-200 px-[16px] gap-3">
          <h1 className="text-[18px] font-bold">{selectedSensor.name}</h1>
          {selectedSensor.status === "operating" ? <div className="size-[6px] rounded-full bg-green-600"></div> : <div className="size-[6px] rounded-full bg-red-600"></div>}
        </div>
